<?php
/**
 * bb_theme functions and definitions
 *
...
if ( ! function_exists( 'bb_theme_setup' ) ) :
	...
	function bb_theme_setup() {
		 ...
		 * If you're building a theme based on bb_theme, use a find and replace
		 * to change 'bb_theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'bb_theme', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'bb_theme' ),
		) );
...
function bb_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bb_theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bb_theme' ),
...
function bb_theme_scripts() {
	wp_enqueue_style( 'bb_theme-style', get_stylesheet_uri() );
